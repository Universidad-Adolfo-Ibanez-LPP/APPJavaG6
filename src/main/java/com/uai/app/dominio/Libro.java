...
//    name,adress,country,cost
    ...
    public String[] getDataToCsv(){
        ...
        return new String[]{ getTitulo().trim(), getAutor().trim(), String.valueOf(getAnio()).trim(), String.valueOf(getEstante_numero()).trim(),
                getEstante_seccion().trim(),String.valueOf(getPiso()).trim(),getEdificio().trim(),getSede().trim()};
    }
    @Override
